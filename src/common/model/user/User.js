...
import { UserRole, UserRoleAbleList } from "./UserRole";
...
export default class User extends BaseEntity {
  static URL_USER_STATUS = "/api/user/status";
  ...
  getFilters() {
    return [
      new Filter(FilterType.SORT, "序号", "orderSort"),
      ...
      new Filter(FilterType.SELECTION, "角色", "role", UserRoleAbleList),
